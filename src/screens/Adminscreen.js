...
export function Bookings() {
  ...
  const getData = async () => {
    try {
      const data = await (
        await axios.get(
          "https://hotel-booking-app-lemon.vercel.app/api/bookings/getallbookings"
        )
      ).data;
      setbookings(data);
      setisloading(false);
...
export function Users() {
  ...
  const getData = async () => {
    try {
      const data = await (
        await axios.get(
          "https://hotel-booking-app-lemon.vercel.app/api/users/getallusers"
        )
      ).data;
      setusers(data);
      setisloading(false);
  ...
  async function addRoom() {
    ...
    try {
      ...
      const result = await axios.post(
        "https://hotel-booking-app-lemon.vercel.app/api/rooms/addroom",
        newroom
      ).data;
